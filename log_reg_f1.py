...
for bag_index, bag_file in enumerate(bag_files):
	...
	log_reg_clf = LogisticRegression(penalty=’l1’)
	...
	log_reg_f1_score = f1_score(y_test,y_pred,average ='binary')
	#print(rf_f1_score)
	...
	results_file.write("\"{file_name}\",{sample_size},\"{algorithm}\",\"{parameters}\",\"{log_reg_f1_score}\",\"{precision_score}\",{recall_score},".format(file_name=bag_files_names[bag_index], sample_size=main.n_samples, algorithm='log_reg_clf', parameters=log_reg_clf.get_params,log_reg_f1_score=log_reg_f1_score,precision_score=precision_score,recall_score=recall_score))
