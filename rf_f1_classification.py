...
for bag_index, bag_file in enumerate(bag_files):
	...
	#gnb_f1_score = f1_score(y_test,y_pred,average ='micro')
	...
	from sklearn.metrics import f1_score 
	rf_f1_score = f1_score(y_test,y_pred,average ='binary')
	#print(rf_f1_score)
	...
	results_file.write("\"{file_name}\",{sample_size},\"{algorithm}\",\"{parameters}\",\"{rf_f1_score}\",\"{precision_score}\",{recall_score},".format(file_name=bag_files_names[bag_index], sample_size=main.n_samples, algorithm='Random_forest', parameters=random_forest_clf.get_params,rf_f1_score=rf_f1_score,precision_score=precision_score,recall_score=recall_score))
